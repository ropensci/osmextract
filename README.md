...
The goal of `osmextract` is to make it easier for people access freely
available, community created geographic data using free and open
software that is conducive to reproducible and transparent research in
the public interest. `osmextract` downloads, converts and imports bulk
