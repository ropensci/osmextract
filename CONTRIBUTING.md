...
- We recommend that you create a Git branch for each pull request
  (PR).  
- Look at the Gihub Actions build status before and after making
  changes.
- We recommend the tidyverse [style guide](http://style.tidyverse.org).
  ...
  nothing to do with your PR. The only difference is that we adopt the
...
Please note that the osmextract project is released with a [Contributor
