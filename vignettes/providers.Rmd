...
The aim of this vignette is to provide a simple guide on adding a new provider to `osmextract`. 
...
There are three main steps to add a new provider: creating the zones, adding the provider and documentating it. 
