...
oe_explore_pattern("London")
oe_explore_pattern("Russia")
oe_explore_pattern("Korea")
oe_explore_pattern("Yorkshire")
oe_explore_pattern("US")
oe_explore_pattern("US", match_by = "iso3166_2")
oe_explore_pattern("Palestine")
israel_sf = oe_explore_pattern("Israel", full_row = TRUE)
```
