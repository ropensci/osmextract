...
Perhaps, the best known bulk OSM data provider is [Geofabrik](https://www.geofabrik.de/), represented as a `data.frame` in the packaged object `geofabrik_zones`.
