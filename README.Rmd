...
`osmextract` downloads, converts and imports bulk OSM data hosted by providers such as [Geofabrik
...
Give `osmextract` a place name and it will try to find it in a list of names in the specified provider (Geofabrik by default).
