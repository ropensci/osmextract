...
For information on alternative providers and how to add them see the [providers vignette](https://itsleeds.github.io/osmextract/articles/providers.html).
...
Please, raise [a new issue](https://github.com/ITSLeeds/osmextract/issues) if you find any odd behaviour. 
...
See the [Introducing osmextract vignette](https://itsleeds.github.io/osmextract/articles/osmextract.html) for more details.
...
If you have any doubt, or if you want to suggest a new approach, or if you want to add a new OSM provider, feel free to create a new issue in the [issue tracker](https://github.com/ITSLeeds/osmextract/issues) or a new [pull request](https://github.com/ITSLeeds/osmextract/pulls). 
We always try to create the most intuitive user interface and the most informative error messages, but if you think that something is not clear and could have been explained better, please let us know. 
