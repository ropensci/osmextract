...
The package is designed to complement `osmdata` which has advantages over `geofabrik` for small datasets: it's likely to be quicker for datasets less than ~10 MB, provides up-to-date data and has an intuitive interface.
